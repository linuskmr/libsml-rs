...
/// See <https://github.com/volkszaehler/libsml/blob/master/sml/include/sml/sml_shared.h>
pub struct Buffer<'a>(pub(crate) *mut libsml_sys::sml_buffer, pub(crate) PhantomData<&'a ()>);
...
impl<'a> Buffer<'a> {
	...
	pub fn optional_is_skipped(buf: crate::Buffer) -> bool {
		unsafe { libsml_sys::sml_buf_optional_is_skipped(buf.0) as u32 == libsml_sys::SML_OPTIONAL_SKIPPED }
	}
}
